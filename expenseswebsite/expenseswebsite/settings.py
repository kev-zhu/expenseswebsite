...
SECRET_KEY = 'django-insecure-2h+4q)31k*(#o+6v$)t+_tqw%qh0s)w=brpzec$hmmz&lk94_s'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'expenseswebsite/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# STATIC_ROOT = BASE_DIR / 'expenseswebsite/static'
